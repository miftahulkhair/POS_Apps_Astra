    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Transfer Stock <Detail></Detail></h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Transfer Stock Detail</h3>
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <h6>Created By: ${transferStocks.get().createBy}</h6>
                    <h6>Transfer Status: ${transferStocks.get().status}</h6>

                    <div class="form-group green-border-focus">
                        <label for="exampleFormControlTextarea5">Notes: </label>
                        <textarea readonly class="form-control" id="exampleFormControlTextarea5" rows="5">${transferStocks.get().notes}</textarea>
                    </div>

                    <hr>

                    <h3>Status History</h3>
                    <c:forEach items="${transferStockHistories}" var="transferStockHistory">
                    <h6>On ${transferStockHistory.createOn} - ${transferStockHistory.status}</h6>
                    </c:forEach>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Transfer Stock Items</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <c:forEach items="${transferStockDetails}" var="transferStockDetail">
                                <tr>
                                    <td>${transferStockDetail.variant.item.name} - ${transferStockDetail.variant.name}</td>
                                    <td>${transferStockDetail.instock}</td>
                                    <td>${transferStockDetail.transferQty}</td>
                                </tr>
                                </c:forEach>
